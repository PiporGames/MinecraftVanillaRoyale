...
tellraw @a ["",{"text":"| Etapa "},{"text":"5","color":"dark_purple","bold":true},{"text":" | Tiempo ","color":"none","bold":false},{"text":"30s","color":"dark_purple","bold":true},{"text":" |","color":"none","bold":false}]
