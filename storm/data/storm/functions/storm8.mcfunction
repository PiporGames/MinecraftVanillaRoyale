...
tellraw @a ["",{"text":"| Etapa "},{"text":"8","color":"dark_purple","bold":true},{"text":" | Tiempo ","color":"none","bold":false},{"text":"30s","color":"dark_purple","bold":true},{"text":" |","color":"none","bold":false}]
playsound minecraft:custom.stormalert player @a ~ ~ ~ 100000000000 1
worldborder set 10 30
time set day
weather thunder