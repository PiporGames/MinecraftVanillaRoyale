...
tellraw @a ["",{"text":"| Etapa "},{"text":"1","color":"dark_purple","bold":true},{"text":" | Tiempo ","color":"none","bold":false},{"text":"120s","color":"dark_purple","bold":true},{"text":" |","color":"none","bold":false}]
playsound minecraft:custom.stormalert player @a ~ ~ ~ 100000000000 1
worldborder set 550 120